...
pub async fn insert_users_batch(executor: impl sqlx::Executor<'_, Database = sqlx::Postgres>, items: Vec<InsertUsersBatchRecord>) -> Result<Vec<InsertUsersBatchItem>, sqlx::Error> {
...
#[tracing::instrument(level = "debug", skip_all, fields(sql = "SELECT id, name, email, age, profile, created_at, updated_at FROM users ORDER BY created_at DESC"))]
...
#[tracing::instrument(level = "debug", skip_all, fields(sql = "UPDATE users SET updated_at = NOW() $[, name = ${name?}] $[, email = ${email?}] $[, age = ${age?}] WHERE id = ${user_id} RETURNING id, name, email, age, updated_at"))]
pub async fn update_user_fields(executor: impl sqlx::Executor<'_, Database = sqlx::Postgres>, name: Option<String>, email: Option<String>, age: Option<i32>, user_id: i32) -> Result<UpdateUserFieldsItem, sqlx::Error> {
    let mut final_sql = r"UPDATE users SET updated_at = NOW() $[, name = ${name?}] $[, email = ${email?}] $[, age = ${age?}] WHERE id = $1 RETURNING id, name, email, age, updated_at".to_string();
    let mut included_params = Vec::new();
...
#[tracing::instrument(level = "debug", skip_all, fields(sql = "UPDATE users SET updated_at = NOW() $[, name = ${name?}] $[, email = ${email?}] $[, age = ${age?}] WHERE id = ${user_id} RETURNING id, name, email, age, updated_at"))]
pub async fn update_user_fields_diff(executor: impl sqlx::Executor<'_, Database = sqlx::Postgres>, old: &UpdateUserFieldsDiffParams, new: &UpdateUserFieldsDiffParams, user_id: i32) -> Result<UpdateUserFieldsDiffItem, sqlx::Error> {
    let mut final_sql = r"UPDATE users SET updated_at = NOW() $[, name = ${name?}] $[, email = ${email?}] $[, age = ${age?}] WHERE id = $1 RETURNING id, name, email, age, updated_at".to_string();
    let mut included_params = Vec::new();
...
#[tracing::instrument(level = "debug", skip_all, fields(sql = "INSERT INTO users (name, email, age) VALUES (${name}, ${email}, ${age}) RETURNING id, name, email, age, created_at"))]
pub async fn insert_user_structured(executor: impl sqlx::Executor<'_, Database = sqlx::Postgres>, params: &InsertUserStructuredParams) -> Result<InsertUserStructuredItem, sqlx::Error> {
    let query = sqlx::query(
        r"INSERT INTO users (name, email, age) VALUES ($1, $2, $3) RETURNING id, name, email, age, created_at"
    );
...
#[tracing::instrument(level = "debug", skip_all, fields(sql = "SELECT DISTINCT status FROM users ORDER BY status"))]
...
#[tracing::instrument(level = "debug", skip_all, fields(sql = "SELECT * FROM users ORDER BY created_at DESC"))]
...
#[tracing::instrument(level = "debug", skip_all, fields(sql = "SELECT id, name, email FROM users WHERE id = ${id} AND email = ${email}"))]
pub async fn get_user_by_id_and_email(executor: impl sqlx::Executor<'_, Database = sqlx::Postgres>, params: &GetUserByIdAndEmailParams) -> Result<Option<GetUserByIdAndEmailItem>, sqlx::Error> {
    let query = sqlx::query(
        r"SELECT id, name, email FROM users WHERE id = $1 AND email = $2"
    );
...
#[tracing::instrument(level = "debug", skip_all, fields(sql = "DELETE FROM users WHERE id = ${id} AND email = ${email} RETURNING id, email"))]
pub async fn delete_user_by_id_and_email(executor: impl sqlx::Executor<'_, Database = sqlx::Postgres>, params: &GetUserByIdAndEmailParams) -> Result<DeleteUserByIdAndEmailItem, sqlx::Error> {
    let query = sqlx::query(
        r"DELETE FROM users WHERE id = $1 AND email = $2 RETURNING id, email"
    );
    let query = query.bind(params.id);
    let query = query.bind(&params.email);
    let row = query.fetch_one(executor).await?;
...
#[tracing::instrument(level = "debug", skip_all, fields(sql = "UPDATE users SET name = ${name}, email = ${email} WHERE id = ${id} RETURNING id, name, email"))]
pub async fn update_user_contact_info(executor: impl sqlx::Executor<'_, Database = sqlx::Postgres>, params: &GetUserByIdAndEmailItem) -> Result<UpdateUserContactInfoItem, sqlx::Error> {
    let query = sqlx::query(
...
#[tracing::instrument(level = "debug", skip_all, fields(sql = "UPDATE users SET profile = ${profile}, updated_at = NOW() $[, name = ${name?}] $[, email = ${email?}] WHERE id = ${user_id} RETURNING id, name, email, profile, updated_at"))]
pub async fn update_user_profile_diff(executor: impl sqlx::Executor<'_, Database = sqlx::Postgres>, old: &UpdateUserProfileDiffParams, new: &UpdateUserProfileDiffParams, profile: crate::models::UserProfile, user_id: i32) -> Result<UpdateUserProfileDiffItem, sqlx::Error> {
    let mut final_sql = r"UPDATE users SET profile = $1, updated_at = NOW() $[, name = ${name?}] $[, email = ${email?}] WHERE id = $2 RETURNING id, name, email, profile, updated_at".to_string();
    let mut included_params = Vec::new();
...
#[tracing::instrument(level = "debug", skip_all, fields(sql = "UPDATE users SET profile = ${profile}, updated_at = NOW() $[, name = ${name?}] $[, email = ${email?}] WHERE id = ${user_id} RETURNING id, name, email, updated_at"))]
pub async fn update_user_metadata_diff(executor: impl sqlx::Executor<'_, Database = sqlx::Postgres>, old: &UpdateUserProfileDiffParams, new: &UpdateUserProfileDiffParams, profile: crate::models::UserProfile, user_id: i32) -> Result<UpdateUserMetadataDiffItem, sqlx::Error> {
    let mut final_sql = r"UPDATE users SET profile = $1, updated_at = NOW() $[, name = ${name?}] $[, email = ${email?}] WHERE id = $2 RETURNING id, name, email, updated_at".to_string();
    let mut included_params = Vec::new();
...
#[tracing::instrument(level = "debug", skip_all, fields(sql = "SELECT id, name, email FROM users WHERE id = ${user_id}"))]
pub async fn get_user_summary(executor: impl sqlx::Executor<'_, Database = sqlx::Postgres>, user_id: i32) -> Result<UserSummary, sqlx::Error> {
    let query = sqlx::query(
...
#[tracing::instrument(level = "debug", skip_all, fields(sql = "SELECT id, name, email FROM users WHERE email = ${email}"))]
pub async fn get_user_info_by_email(executor: impl sqlx::Executor<'_, Database = sqlx::Postgres>, email: String) -> Result<Option<UserSummary>, sqlx::Error> {
    let query = sqlx::query(
...
#[tracing::instrument(level = "debug", skip_all, fields(sql = "SELECT id, name, email FROM users ORDER BY name"))]
pub async fn get_all_user_summaries(executor: impl sqlx::Executor<'_, Database = sqlx::Postgres>) -> Result<Vec<UserSummary>, sqlx::Error> {
    let query = sqlx::query(
...
#[tracing::instrument(level = "debug", skip_all, fields(sql = "SELECT id, name, email, age, created_at FROM users WHERE id = ${user_id}"))]
pub async fn get_user_details(executor: impl sqlx::Executor<'_, Database = sqlx::Postgres>, user_id: i32) -> Result<UserDetails, sqlx::Error> {
    let query = sqlx::query(
        r"SELECT id, name, email, age, created_at FROM users WHERE id = $1"
    );
    let query = query.bind(user_id);
    let row = query.fetch_one(executor).await?;
    let result: Result<_, sqlx::Error> = (|| {
...
#[tracing::instrument(level = "debug", skip_all, fields(sql = "SELECT id, name, email, age, created_at FROM users WHERE name ILIKE ${pattern}"))]
pub async fn search_user_details(executor: impl sqlx::Executor<'_, Database = sqlx::Postgres>, pattern: String) -> Result<Vec<UserDetails>, sqlx::Error> {
    let query = sqlx::query(
        r"SELECT id, name, email, age, created_at FROM users WHERE name ILIKE $1"
    );
    let query = query.bind(&pattern);
    let rows = query.fetch_all(executor).await?;
    let result: Result<Vec<_>, sqlx::Error> = rows.iter().map(|row| {
...
#[tracing::instrument(level = "debug", skip_all, fields(sql = "SELECT id, name, email FROM users WHERE id = ${id} AND email = ${email}"))]
pub async fn find_user_by_criteria(executor: impl sqlx::Executor<'_, Database = sqlx::Postgres>, params: &GetUserByIdAndEmailParams) -> Result<Option<UserSummary>, sqlx::Error> {
    let query = sqlx::query(
        r"SELECT id, name, email FROM users WHERE id = $1 AND email = $2"
    );
    let query = query.bind(params.id);
